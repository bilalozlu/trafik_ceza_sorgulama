...
The project is started with create-react-native-app and not ejected. Since node_modules are not uploaded, you should download them by "npm install" command to use app.
